...
if False:
        ...
        p.initialization()
        #print(p.getData()) 
        #p.data = ['<space>', '0', 'p;F3;s', 'False', '180;17']
        #p.getData() = {'Kick-Key':'<space>', 'GamingIntro-Init':'0', 'Bindings':'p;F3;s', 'DevMode':'False', 'Scales':'180;17', 'Color':'#00ff00'}
        p.mainloop()'''
#================================================
        def cicco():
                global a
                p = Preference(pathinit="C:/Users/{0}".format(__file__.split("\ "[0])[2]) + "/")
                #print(p.getData())
                p.initialization()
                #print(p.getData()) 
